<div class="row">
    ...
    <div class="col-lg-6">
        ...
        <div class="col-lg-9">
            {!! Form::text('EVN_NOMBRE','', ['class' => 'form-control' , 'id' => 'EVN_NOMBRE']) !!}
        </div>
    </div>
    <div class="col-lg-6">
        {!! Form::label('FTO_ID', 'FORMATO', array('class' => 'col-lg-3')) !!}
        <div class="col-lg-9">
            {!! Form::select('FTO_ID', $formatos, isset($evento->FTO_ID) ? $mazo->FTO_ID : '', array('class' => 'form-control col-lg-6')) !!}
        </div>
    </div>
    <div class="col-lg-6">
        {!! Form::label('TND_ID', 'TIENDA', array('class' => 'col-lg-3')) !!}
        <div class="col-lg-9">
            {!! Form::select('TND_ID', $tiendas, isset($evento->TND_ID) ? $tienda->TND_ID : '', array('class' => 'form-control col-lg-6')) !!}
        </div>
    </div>
    <div class="col-lg-6">
        ...
        <div class="col-lg-9">
            <div class="input-group date" data-provide="datepicker">
                <input type="text" class="form-control" name="FECHA" id="FECHA" readonly="readonly" >
